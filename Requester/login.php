...
<body>
    <div class="mt-5 text-center " style="font-size:30px">
        ...
        <p class="mt-5 text-center " style="font-size:20px"><i class="fas fa-user-secret text-danger mr-2"></i>Requester Area</p>
        <?php 
              ...
              $msg = "<div class='alert alert-warning mt-2' roll='alert'>Field must not be empty</div>";
                ...
                if($data->rowCount() > 0){
                   ...
                   echo "<script>window.location='profile.php'</script>";
                    ...
                    $msg ="<div class='alert alert-danger mt-2' roll='alert'>Login not successfull</div>";
                }
